...
dropout_config = {
    ...
    'dropout1': {'config': {'dropout_rate': 0.2}, 'inbound_nodes': ['relu1']},

    'max_pooling1': {'config': {'kernel_size': 2, 'stride': 2}, 'inbound_nodes': ['dropout1']},
    ...
    'dropout2': {'config': {'dropout_rate': 0.2}, 'inbound_nodes': ['relu2']},

    'max_pooling2': {'config': {'kernel_size': 2, 'stride': 2}, 'inbound_nodes': ['dropout2']},
    ...
    'dropout3': {'config': {'dropout_rate': 0.2}, 'inbound_nodes': ['relu3']},

    'fc1': {'config': {'input_size': 256*8*8, 'output_size': 10}, 'inbound_nodes': ['dropout3']},
}